"""CUB-200-2011 under the real free-grain setting (CUB-Real), generating superpixels.

See `birds_real.py` for the encoding of the given labels.
"""
    ...
    def __init__(self,
        ...
        if is_train:
            if texts:
                ...
                # HSG：聚合科级(38)/目级(13)文本语义（标注已给 0-based 标签，冻结）
                ...
                z_family = torch.zeros(38, cap_t.size(1)); cf = torch.zeros(38)
                ...
                z_order = torch.zeros(13, cap_t.size(1)); co = torch.zeros(13)
