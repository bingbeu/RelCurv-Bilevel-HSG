    ...
    def __init__(self, 
        ...
        if is_train:
            ...
            if texts is not None:
                ...
                # HSG：聚合科级(127)/目级(20)文本语义（标注已给 0-based 标签，冻结）
                ...
                z_family = torch.zeros(127, cap_t.size(1)); cf = torch.zeros(127)
                ...
                z_order = torch.zeros(20, cap_t.size(1)); co = torch.zeros(20)
